...
void genTxt(const string &inTxt, const string &outTxt) {
    ...
    while (fgets(line, 256, inFile)) {
		...
		pts = "C:/Users/atara/Documents/Visual Studio 2015/Projects/OpencvFERWin32Console/x64/Data/68/" + pts;
		...
		img_path = "C:/Users/atara/Documents/Visual Studio 2015/Projects/OpencvFERWin32Console/x64/Data/68/" + img_path;
		
		LOG("Absolute: %s", img_path.c_str());
